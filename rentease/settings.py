...
AUTH_TOKEN = config('TOKEN', default='')
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'django.con'
        'trib.auth.password_validation.MinimumLengthValidator',
    },
    {
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'nandhanancas@gmail.com'
EMAIL_HOST_PASSWORD = 'hrtfrexsbmuuyooo'
DEFAULT_FROM_EMAIL  = 'nandhanancas@gmail.com'
